...
[🌐 Live Demo](https://Sanugiw.github.io) • [📁 Repository](https://github.com/Sanugiw/Sanugiw.github.io) • [📧 Contact](mailto:sanugidwickramasinghe@gmail.com)
...
**Key Highlights:**
- 🎓 Third-year Biomedical Engineering student at University of Moratuwa
- 🔬 Focus on biosignal processing, medical instrumentation, and ML for healthcare
- 💡 Designed intelligent, human-centered biomedical systems
- 🤝 Active contributor to IEEE EMBS and AIESEC

---

## ✨ Features

- **🏠 Home Page** – Clean landing page with personal introduction and background
- **📊 About Section** – Comprehensive overview of research interests, skills, and career goals
- **🚀 Projects Showcase** – Interactive cards featuring key projects:
  - **X-Hale** – Portable smart spirometer for respiratory health monitoring
  - **ML-Integrated Fundoscope** – Table-mounted retinal imaging system with diabetic retinopathy classification
  - **Deep Learning for ECG** – Automated arrhythmia classification pipeline
  - **MediBox** – IoT-based medicine reminder with environmental monitoring
- **🏆 Honors & Awards** – Achievements including Dean's List placements and leadership recognitions
- **📬 Contact Section** – Direct links to email, GitHub, LinkedIn, and other social platforms
- **🎨 Modern Design** – Responsive card-based layout with dark theme aesthetic
- **⚡ Fast Performance** – Lightweight, static site with minimal dependencies
...
Sanugiw.github.io/
│
├── index.html          # Main landing page with about section
...
Made with ❤️ by Sanugi Wickramasinghe
